function Import-MoveEngine {
    # Load an optional engine module (DotnetMove.Unity / DotnetMove.Native) on demand: prefer an
    # already-loaded or installed module, else the sibling source manifest next to DotnetMove.Core.
